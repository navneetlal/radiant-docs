...
const config = {
  ...
  stylesheets: [
    'https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;700;900&family=Source+Sans+Pro&display=swap'
  ],
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Intugine Technologies, Inc. Built with Docusaurus.`,
      },
      prism: {
